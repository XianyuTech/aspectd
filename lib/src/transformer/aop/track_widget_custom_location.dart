...
const String _creationLocationParameterName =
    r'$customCreationLocationd_0dea112b090073317d4';
...
const String _locationFieldName = r'_customLocation';

/// root url for example
String _rootUrl;
      ...
      if (importUri != null && importUri.scheme == 'package') {
        if (importUri.path == 'flutter/src/widgets/framework.dart' ||
          ...
          if (importUri.path.contains("main.dart")){
            if(library.fileUri.toString().endsWith("/lib/main.dart")){
              _rootUrl = library.fileUri.toString().replaceAll("/lib/main.dart", "");
              print('[RootUrl] = ' + _rootUrl);
            }
          }

          if (importUri.path.contains('growing_impl.dart')) {
            for (Class class_ in library.classes) {
