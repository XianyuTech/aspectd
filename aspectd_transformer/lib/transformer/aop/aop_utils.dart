...
class AopUtils {
  ...
  static String kImportUriAopAspect =
      'package:aspectd_annotation/annotation/aspect.dart';
  static String kImportUriAopCall =
      'package:aspectd_annotation/annotation/call.dart';
  static String kImportUriAopExecute =
      'package:aspectd_annotation/annotation/execute.dart';
  static String kImportUriAopInject =
      'package:aspectd_annotation/annotation/inject.dart';
  static String kImportUriPointCut =
      'package:aspectd_annotation/annotation/pointcut.dart';
